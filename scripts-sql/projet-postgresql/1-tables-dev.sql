...
CREATE TABLE participant (
	...
	reglement		BOOLEAN			NOT NULL DEFAULT FALSE,
	repas			INT				NOT NULL,
...
CREATE TABLE equipe (
	...
	FOREIGN KEY (idchef) REFERENCES participant (idparticipant),
	FOREIGN KEY (idcoequipier) REFERENCES participant (idparticipant)
